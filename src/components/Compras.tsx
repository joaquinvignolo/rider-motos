...
const Compras = () => {
	...
	// Cargar marcas, segunda marcas y proveedores
			...
			return (
				<div className="compras-bg">
							<div className="compras-container">
								<h1 style={{ color: '#fff', fontWeight: 700, fontSize: '2.5rem', marginBottom: '32px', letterSpacing: '2px' }}>Compras</h1>
								...
								<div className="nueva-compra">
									...
									<button className="btn-agregar" onClick={agregarAlCarrito}>Agregar al carrito</button>
										...
										<div className="carrito">
											<h3 style={{ marginTop: '8px', marginBottom: '18px' }}>Carrito de Compras</h3>
